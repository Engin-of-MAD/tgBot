...
class MyKb:
    ...
    m_txt = ["Пожалуйста выберете пункт меню", "Пожалуйста выберите нужный тип занятий",
             "Пожалуйста выберите нужную аудиторию", "Пожалуйста выберете время занятия Аудитория A",
